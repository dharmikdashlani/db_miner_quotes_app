...
class _LearningState extends State<Learning> {
  ...
  fetch() async {
    Future.delayed(
        ...
        () => setState(() {
              getAllQuotes = DBHelper.dbHelper.fetachAllLearningRecords();
            }));
  }

  forGetVariable() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    bool? isLearningArrived = prefs.getBool('learningArrived') ?? false;

    (isLearningArrived == false)
        ? DBHelper.dbHelper.lodeLearningJasonBank()
        : getAllQuotes = DBHelper.dbHelper.fetachAllLearningRecords();
  }
  ...
  isDataArrived() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool('learningArrived', true);
  }
